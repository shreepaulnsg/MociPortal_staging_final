  ...
  function (
    ...
    var clazz = declare([BaseWidgetPanel, _TemplatedMixin], {
      ...
      _onCloseBtnClicked: function (evt) {
        //alert("onscreen widgetpanel close")
        ...
        if (!$("#dijit__WidgetBase_0").hasClass('jimu-state-selected')) {
          var img = $("#dijit__WidgetBase_0").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/Bookmark/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_1").hasClass('jimu-state-selected')) {
          var img = $("#dijit__WidgetBase_1").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/Measurement/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_2").hasClass('jimu-state-selected')) {
          var img = $("#dijit__WidgetBase_2").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/Identify/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_3").hasClass('jimu-state-selected')) {
          var img = $("#dijit__WidgetBase_3").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/GoToCoordinates/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_4").hasClass('jimu-state-selected')) {
          var img = $("#dijit__WidgetBase_4").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/SearchAll/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_5").hasClass('jimu-state-selected')) {
          var img = $("#dijit__WidgetBase_5").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/PlotFactoryInfo/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_6").hasClass('jimu-state-selected')) {           
          var img = $("#dijit__WidgetBase_6").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/Print/images/icon.png?wab_dv=2.20");
          }
        } if (!$("#dijit__WidgetBase_7").hasClass('jimu-state-selected')) {           
          var img = $("#dijit__WidgetBase_7").find("img"),
            len = img.length;
          if (len > 0) {
            img.attr("src", "/MociPortal/widgets/UpdateAttributes/images/icon.png?wab_dv=2.20");
          }
        }
      },
      ...
      makePositionInfoBox: function () {
        ...
        this._positionInfoBox = {
          w: this.position.width || 450,
          h: this.position.height || 680,
          l: this.position.left || 800,

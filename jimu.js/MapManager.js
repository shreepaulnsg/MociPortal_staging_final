  ...
  var instance = null,
    clazz = declare(null, {
      ...
      constructor: function ( /*Object*/ options, mapDivId) {
        ...
        this.plotAllocationMap = null;
        this.projectStatusMap = null;
        this.delayedPaymentsMap = null;
        this.factoryReportMap = null;
      ...
      _show2DWebMap: function (appConfig) {
        ...
        mapDeferred.then(lang.hitch(this, function (response) {
          ...
          //if(this.layerInfosObj.getLayerInfoArrayOfWebmap()){
          //  alert("this.layerInfosObj Success")
        ...
        // var plotAllocation = this._createWebMapRaw(webMapPortalUrl, "5076ae91c40d4faab84edcb8da660496", "plotDiv", webMapOptions);

        // plotAllocation.then(lang.hitch(this, (response) => {
        //    this.plotAllocationMap = response.map;
          //   //var extent;
          //   this.plotAllocationMap.itemId = "5076ae91c40d4faab84edcb8da660496";
          //   this.plotAllocationMap.itemInfo = response.itemInfo;
          //   this.plotAllocationMap.webMapResponse = response;
          //   // enable snapping
          //   var options = {
          //     snapKey: keys.copyKey
          //   };
          //   this.plotAllocationMap.enableSnapping(options);

          //   html.setStyle(this.plotAllocationMap.root, 'zIndex', 0);

          //   this.plotAllocationMap._initialExtent = map.extent;

          //   this.layerInfosObj = LayerInfos.getInstanceSyncForInit(this.plotAllocationMap, this.plotAllocationMap.itemInfo);
        ...
        // var projStatus = this._createWebMapRaw(webMapPortalUrl, "7b912e5c0a794dbf9d98ae704ba8a80f", "projDetailsDiv", webMapOptions);

        // projStatus.then(lang.hitch(this, (response) => {
        //   this.projectStatusMap = response.map;
        // }));

        // var delayedPayments = this._createWebMapRaw(webMapPortalUrl, "f77f7a76a5f744edbc3d0ade1885cca0", "delayedPaymentsDiv", webMapOptions);

        // delayedPayments.then(lang.hitch(this, (response) => {
        //   this.delayedPaymentsMap = response.map;
        // }));

        // var factory = this._createWebMapRaw(webMapPortalUrl, "75e9506f2b004bec86ef5e759fa303b8", "factoryReportDiv", webMapOptions);

        // factory.then(lang.hitch(this, (response) => {
        //   this.factoryReportMap = response.map;
            //var extent;
            // this.factoryReportMap.itemId = "75e9506f2b004bec86ef5e759fa303b8";
            // this.factoryReportMap.itemInfo = response.itemInfo;
            // this.factoryReportMap.webMapResponse = response;
            // // enable snapping
            // var options = {
            //   snapKey: keys.copyKey
            // };
            // this.factoryReportMap.enableSnapping(options);

            // html.setStyle(this.factoryReportMap.root, 'zIndex', 0);

            // this.factoryReportMap._initialExtent = map.extent;

            // this.layerInfosObj = LayerInfos.getInstanceSyncForInit(this.factoryReportMap, this.plotAllocationMap.itemInfo);

    ...
    ********************************************************/
    ...
    _tryLoadConfig: function() {
      ...
      if(this.urlParams.config) {
       ...
       //added by Lakshmi on 08-12-2021
       ...
       if (pageUrl.includes("?locale=ar")) {  
        ...
        //  alert('Public')
          ...
          this.configFile = "configPublic_AR.json";
          this._generateTokenForPublic();
        }
        else if(sessionStorage.getItem("UserType")=="Investor"){
         // alert('Investor')
          this.configFile = "configInvestors_AR.json";
          this._registerTokenforusers();
        }
        else if(sessionStorage.getItem("UserType")=="DeptViewer1"){
        //  alert('DeptViewer1')
          this.configFile = "configDeptViewer1_AR.json";
          this._registerTokenforusers();
        }
        else if(sessionStorage.getItem("UserType")=="DeptViewer2"){
         // alert('DeptViewer2')
          this.configFile = "configDeptViewer2_AR.json";
          this._registerTokenforusers();
        }
        else if(sessionStorage.getItem("UserType")=="DeptEditor"){
         // alert('DeptEditor')
          this.configFile = "configDeptEditor_AR.json";
          this._registerTokenforusers();
        }
        else{
         // alert('default Public')
         // this.configFile = "config.json";
          this.configFile = "configPublic.json";
          this._generateTokenForPublic();
         // this.configFile = "configInvestors.json";
        }
        ...
        if(sessionStorage.getItem("UserType")=="Public"){
          ...
          //  alert('DeptViewer1')
            this.configFile = "configDeptViewer1.json";
            this._registerTokenforusers();
          }
          else if(sessionStorage.getItem("UserType")=="DeptViewer2"){
           // alert('DeptViewer2')
            this.configFile = "configDeptViewer2.json";
            this._registerTokenforusers();
          }
          else if(sessionStorage.getItem("UserType")=="DeptEditor"){
           // alert('DeptEditor')
            this.configFile = "configDeptEditor.json";
            this._registerTokenforusers();
          }
          else{
           // alert('default Public')
...
_registerTokenforusers:function(appConfig){
  if(sessionStorage.getItem("token"))
  {
    //tokenUtils.setPortalUrl(appConfig.portalUrl);
    token = sessionStorage.getItem("token");
    tokenUtils.setPortalUrl("https://gisstg.moci.gov.qa/geoportal");
    tokenUtils.registerToken(token).then(function(){
      console.log('Token registered')
     // return appConfig;
    });
  }
},
    _generateTokenForPublic:function(){
    ...
    _processSignIn: function(portalUrl, isWebTier){
      ...
      if(window.appInfo.isRunInPortal){
        ...
        defSignIn.promise.always(lang.hitch(this, function(){
          ...
          //call portal self again because the first call is not load,

...
interface TriStateItem extends DojoDeclaredClass, Stateful {}
...
declare class TriStateItem {
   ...
   * If enableTabbing is true, the TristateItem can be controlled by keydown.
   */
  constructor(
  ...
  get(name: "checked"): boolean | "mixed";

  set(name: "checked", value: boolean | "mixed"): this;

 ...
 * @param source A source object. If missing, nothing will be copied.
 * @param target A target object. If missing, a new target object is created.
 * @param conversionCallback A conversion callback applied to Object-type properties.
 * If missing, these properties are assigned as is.
...
export function copyOwnJsonProperties(
  source?: object,
  target?: object,
  conversionCallback?: (property: string, value: JsonMap) => AnyJson
): object;

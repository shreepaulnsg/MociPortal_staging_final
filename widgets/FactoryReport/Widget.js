...
function(declare, BaseWidget) {
  ...
  return declare([BaseWidget], {
    // FactoryReportWidget code goes here

    //please note that this property is be set by the framework when widget is loaded.
    //templateString: template,

    baseClass: 'jimu-widget-FactoryReport',
    demoFromHTMLbtn() {
      ...
      source = '<div><img src="images/PageLogo.png" width=20 height=15 align="left" style="margin-right:30px;"/><h1>Factory Report</h1><img src=images/FactoryReport.png width=150 height=90></img></div>' //$('#content')[0];

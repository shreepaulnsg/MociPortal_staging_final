...
function(declare, BaseWidget) {
  ...
  return declare([BaseWidget], {
    // DelayedPaymentsWidget code goes here

    //please note that this property is be set by the framework when widget is loaded.
    //templateString: template,

    baseClass: 'jimu-widget-DelayedPayments',
    demoFromHTMLbtn() {
      ...
      //source = '<div><img src="images/PageLogo.png" width=20 height=15 align="left" style="margin-right:30px;"/><h1>Delayed Payments</h1><img src=images/DelayedPayments.jpg width=150 height=90></img><img src=images/construction.png width=150 height=80></img></div>' //$('#content')[0];
      source = '<div><img src=images/DelayedPayments.jpg width=150 height=90></img><img src=images/construction.png width=150 height=80></img></div>' //$('#content')[0];

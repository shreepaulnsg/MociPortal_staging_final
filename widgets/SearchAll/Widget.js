...
///////////////////////////////////////////////////////////////////////////
define(['dojo/_base/declare', 'jimu/BaseWidget', 'jimu/WidgetManager', 'dojo/on', "dojo/_base/lang", 'dojo/_base/array', "dojo/store/Memory", "dojo/data/ItemFileReadStore", "dijit/form/ComboBox", "esri/request", "esri/tasks/query", "esri/tasks/QueryTask", "esri/layers/FeatureLayer", "esri/symbols/SimpleFillSymbol", "esri/symbols/SimpleLineSymbol", "esri/Color", "esri/graphic", 'jimu/utils', "dojo/dom", 'jimu/LayerInfos/LayerInfos'],
  function (declare, BaseWidget, WidgetManager, on, lang, array, Memory, ItemFileReadStore, ComboBox, esriRequest, Query, QueryTask, FeatureLayer, SimpleFillSymbol, SimpleLineSymbol, Color, Graphic, utils, dom, LayerInfos) {
    ...
    return declare([BaseWidget], {
      ...
      postCreate: function () {
        ...
        this.getLayerInfo("https://mocihqingiaps01.moci.gov.qa/server/rest/services/Moci/IndustrialPlot/MapServer/0");
       // this.getLayerInfo("https://mociazingiapt01.mocidt.gov.qa/server/rest/services/Moci/IndustrialPlots/MapServer/0");
      },
      ...
      startup: function () {
        ...
        on(searchDiv, "click", lang.hitch(this, () => {
          this.searchValues();
        }));
        var clearDiv = dom.byId("divClear");
        on(clearDiv, "click", lang.hitch(this, () => {
          this.reloadData();
        }));
      ...
      plotStPopulateList: function (results) {
       ...
       // this.loadData('plotStatus', "PLOT_STATUS_AR", plotrows, "Allocation_Status_AR");
      ...
      zoomToData: function (pinNocondition) {
        ...
        this.queryTask.execute(queryFeat).then(lang.hitch(this, function (results) {
          ...
          if (qryFeatures.length > 0) {
            ...
            currentLayer = this.createresults();
            this._addOperationalLayer(currentLayer);
            for (var i = 0, len = qryFeatures.length; i < len; i++) {
              var feature = qryFeatures[i];
              if (feature.geometry) {
      ...
      createresults: function () {
        ...
        var reslayerinfo = this.LAYERINFO;
        reslayerinfo.name = "Search Results"
        var featureCollection = {
          layerDefinition: reslayerinfo,
          featureSet: null
        };
